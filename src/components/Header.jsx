  ...
  return (
    <header className="mx-auto my-48 text-center">
      <h1>
        ...
        <br />
        <span className="m-0 text-gray-700 border-gray-200 font-semibold tracking-wide border-b-8 text-5xl md:text-6xl lg:text-8xl">
          The Map Equation
        </span>
      </h1>
      <div className="mt-44 text-gray-600 text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
