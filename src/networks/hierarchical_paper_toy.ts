...
const bridgeLinks = [
  ...
  { source: 21, target: 25, weight: 1 },
  { source: 24, target: 26, weight: 1 },
  { source: 5, target: 10, weight: topModuleLinkWeight },
  { source: 9, target: 19, weight: topModuleLinkWeight },
  { source: 18, target: 23, weight: topModuleLinkWeight },
];
